"""
stages/3_data_augmentation/08_stratified_split.py
------------------------------------
...
Run:
    python stages/3_data_augmentation/08_stratified_split.py --config config/pipeline.yaml
"""
...
def run(args: argparse.Namespace) -> None:
    ...
    df_main, df_canary = _stratified_split(
    ...
    df_main, df_adversarial = _stratified_split(
    ...
    df_main, df_test = _stratified_split(
    ...
    df_train, df_val = _stratified_split(
...
def _stratified_split(
    ...
    """Stratified split on _strat_key; falls back to random if any class has < 2 members."""
    strat = df["_strat_key"]
